...
import Meet from './tab2/meet';
// import EventDay from './Tab1/EventDay';
import VisitTab from './visit/VisitTab';
import { createStackNavigator } from '@react-navigation/stack';
import { getFocusedRouteNameFromRoute } from '@react-navigation/native';
import MeetMainPage from './tab2/meet';
import WhenToMeet from './tab2/make/makemeet';
import React, { useLayoutEffect } from 'react';
import { NavigationContainer } from '@react-navigation/native';
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs';
import { createNativeStackNavigator } from '@react-navigation/native-stack';
import SearchLocation from './tab2/make/setlocation';
import Login from './Login/Login';
import MeetingDetail from './tab2/meetdetail/meetdetail';
